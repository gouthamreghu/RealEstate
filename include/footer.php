    ...
    <div class="container">
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="footer-widget mb-4">
                                <div class="footer-logo mb-4"> <a href="#"><img class="logo-bottom"
                                            src="images/logo/restatelg white.png" alt="image"></a> </div>
                                <p class="pb-20 text-white">The Smart City Real Estate app is a cutting-edge platform
                                    designed to revolutionize the way you navigate and engage with urban living.
                                    Seamlessly integrating advanced technologies, this app provides real-time access to
                                    a curated selection of properties in smart cities, combining convenience,
                                    ...
                                    <div class="footer-widget">
                                        ...
                                        <ul class="text-white">
                                            <li class="hover-text-primary"><i
                                                    class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>27
                                                Ingram Street, Dayton</li>
                                            <li class="hover-text-primary"> <i
        ...
        <div class="row copyright">
            <div class="col-sm-6"> <span class="text-white">©
                    <?php echo date('Y'); ?> Real Estate Website
                </span> </div>
            <div class="col-sm-6">
